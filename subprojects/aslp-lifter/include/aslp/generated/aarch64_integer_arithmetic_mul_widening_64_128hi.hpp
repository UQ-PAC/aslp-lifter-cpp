...
void aslp_lifter<Traits>::f_aarch64_integer_arithmetic_mul_widening_64_128hi(typename Traits::bits v_enc) {
  ...
  if (iface.f_eq_bits(iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("23"), /*wd*/ iface.bigint_lit("1")), iface.bits_lit(1U, "1"))) {
    v_If16__2 = iface.f_gen_ZeroExtend(v_X_read5__2, iface.f_gen_int_lit(iface.bigint_lit("65")));
  } else {
    v_If16__2 = iface.f_gen_SignExtend(v_X_read5__2, iface.f_gen_int_lit(iface.bigint_lit("65")));
  } // if
  auto v_If20__2 = typename Traits::rt_expr{};
  if (iface.f_eq_bits(iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("23"), /*wd*/ iface.bigint_lit("1")), iface.bits_lit(1U, "1"))) {
    v_If20__2 = iface.f_gen_ZeroExtend(v_X_read10__2, iface.f_gen_int_lit(iface.bigint_lit("65")));
  } else {
    v_If20__2 = iface.f_gen_SignExtend(v_X_read10__2, iface.f_gen_int_lit(iface.bigint_lit("65")));
  } // if
  ...
  if (iface.f_ne_bits(iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("0"), /*wd*/ iface.bigint_lit("5")), iface.bits_lit(5U, "11111"))) {
    iface.f_gen_array_store(iface.v__R(), iface.f_cvt_bits_uint(iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("0"), /*wd*/ iface.bigint_lit("5"))), iface.f_gen_slice(iface.f_gen_slice(iface.f_gen_mul_bits(iface.f_gen_SignExtend(v_If16__2, iface.f_gen_int_lit(iface.bigint_lit("129"))), iface.f_gen_SignExtend(v_If20__2, iface.f_gen_int_lit(iface.bigint_lit("129")))), iface.bigint_lit("0"), iface.bigint_lit("128")), iface.bigint_lit("64"), iface.bigint_lit("64")));
  } // if

} // f_aarch64_integer_arithmetic_mul_widening_64_128hi
