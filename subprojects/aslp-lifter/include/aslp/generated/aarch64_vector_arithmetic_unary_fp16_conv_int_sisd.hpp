...
void aslp_lifter<Traits>::f_aarch64_vector_arithmetic_unary_fp16_conv_int_sisd(typename Traits::bits v_enc) {
...
} // f_aarch64_vector_arithmetic_unary_fp16_conv_int_sisd
