...
void aslp_lifter<Traits>::f_aarch64_vector_cvt_bf16_scalar(typename Traits::bits v_enc) {
  ...
  v_Exp13__3 = iface.f_gen_FPConvertBF(iface.f_gen_slice(v_Exp7__2, iface.bigint_lit("0"), iface.bigint_lit("32")), iface.f_gen_load(iface.v_FPCR()), iface.f_gen_cvt_bits_uint(iface.f_gen_load(v_FPDecodeRounding11__4)));
...
} // f_aarch64_vector_cvt_bf16_scalar
