...
void aslp_lifter<Traits>::f_aarch64_integer_pac_autia_hint(typename Traits::bits v_enc) {
  auto v_d__1 = iface.bits_zero(iface.bigint_lit("5"));
  auto v_n__1 = iface.bits_zero(iface.bigint_lit("5"));
  auto v_source_is_sp__1 = false;
  if (iface.f_eq_bits(iface.f_append_bits(iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("8"), /*wd*/ iface.bigint_lit("4")), iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("5"), /*wd*/ iface.bigint_lit("3"))), iface.bits_lit(7U, "0011100"))) {
    v_d__1 = iface.bits_lit(5U, "11110");
    v_n__1 = iface.bits_lit(5U, "11111");
  } else {
    if (iface.f_eq_bits(iface.f_append_bits(iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("8"), /*wd*/ iface.bigint_lit("4")), iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("5"), /*wd*/ iface.bigint_lit("3"))), iface.bits_lit(7U, "0011101"))) {
      v_d__1 = iface.bits_lit(5U, "11110");
      v_source_is_sp__1 = true;
    } else {
      if (iface.f_eq_bits(iface.f_append_bits(iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("8"), /*wd*/ iface.bigint_lit("4")), iface.extract_bits(v_enc, /*lo*/ iface.bigint_lit("5"), /*wd*/ iface.bigint_lit("3"))), iface.bits_lit(7U, "0001100"))) {
...
} // f_aarch64_integer_pac_autia_hint
